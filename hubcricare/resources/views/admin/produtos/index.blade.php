                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3" style="display: flex;justify-content: space-between; align-items:baseline;">
                                ...
                                <a href=" " class="btn btn-primary" style="margin-right: 1rem !important">Criar novo Projeto</a>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Poção Corrupta</h6>
                                                    </div>
                                                </div>
                                            </td>
        ...
        <div id="modal-excluir" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" align="center">Tem certeza de que quer excluir esse Projeto?</div>
                    <div class="modal-footer">
    ...
    $(document).ready(function() {
        ...
        $('#modal-detalhes').on('show.bs.modal', function(event) {
            ...
            $.getJSON(url, (resposta) => {
                $("#detalhes-title").val(resposta[0].title);
        ...
        $('#modal-excluir').on('show.bs.modal', function(event) {
            ...
            $.getJSON(url, (resposta) => {
                if (resposta[1]) {
                    $("#remove-client").html("O cliente " + resposta[1].name + " também será excluido!");
                } else {
                    $("#remove-client").html("");
                }
            });
            $('#form-excluir').attr('action', 'portfolio/' + id)
        })
    });
</script>
